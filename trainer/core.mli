...
val init_trainer : string -> Creature.Core.t -> Creature.Core.t -> Creature.Core.t -> t
...
val modify_creature : t -> Creature.Core.t -> t
...
val creature_of : t -> Creature.Core.t
...
val creature_with_name : t -> string -> Creature.Core.t
...
(** [use_move t c m] is the result of trainer [t] using move [m] of creature [c]. This can
    raise [Creature.InvalidMove] or [Move.Core.NoMoreUses] based on those corresponding
    conditions. *)
